                ...
                <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="carnetVacunas" value="" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="raza" value="" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="tamano" value="" class="form-control">
                        </div>
                    </div>
